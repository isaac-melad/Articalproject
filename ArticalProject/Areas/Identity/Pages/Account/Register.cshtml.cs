...
namespace ArticalProject.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public RegisterModel(
            ...
            IEmailSender emailSender, IRepo<Author> repo)
        {
        ...
        public class InputModel
        {
            ...
            [Compare("Password", ErrorMessage = "كلمه السر يجب ان تكون مطابقه ")]
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    repo.Add(author);
                    // add claims
                    System.Security.Claims.Claim claims = new System.Security.Claims.Claim("User", "User");
